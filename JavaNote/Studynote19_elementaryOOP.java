...
class beginner{
	public static void main(String[] args){
		...
		//第三题相关代码
		ThisBook book = new ThisBook("古剑奇谭", 200);
		book.info();
...
/*第三题：编写类 ThisBook,定义方法updatePrice,实现更改某本书的价格，
具体：如果价格>150，则更改为150，如果价格>100，更改为100,否则不变；
*/
class ThisBook{
	String name;
	double price;
	public ThisBook(String name, double price) {
		this.name = name;
		this.price = price;
	}
...
class ThisCalc{
	double num1;
	double num2;
	public ThisCalc(double num1, double num2){
		this.num1 = num1;
		this.num2 = num2;
	}
...
class PassObject{
	public void printAreas(ThisCircle c,int times){
